...
Only 2 characters from the last word are :  ou
'Hello' is present in the string at index :  0
Change lowercase letter to uppercase and vice versa :  hELLO, hOW ARE YOU
Check if the string is in uppercase :  False
Separate the words of the string by a comma :  Hello,,How,are,you
Separate the words of the string by a comma (using join()):  Hello,,How,are,you
Replace the word 'Hello' with 'Hi' :  Hi, How are you
'''